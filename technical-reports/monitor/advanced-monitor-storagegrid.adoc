...
image:monitor-metrics-page.png["page-metrics-moniteur"]

Vous pouvez également accéder directement au lien.

image:monitor-prometheus-interface.png["interface-prometheus"]
...
+
image:monitor-metrics-query.png["surveillance-metrics-requête"]
...
+
image:monitor-sample-prometheus-query-responses.png["monitor-sample-réponses-requêtes-prometheus"]
