...
+
image:monitor-matching-rule.png["règle-correspondance-moniteur"]

. Définissez une limite (facultatif).
+
image:monitor-limit.png["limite-moniteur"]

. Enregistrez votre police
+
image:monitor-traffic-policy.png["surveiller la stratégie de trafic"]
...
+
image:monitor-dashboard-showing-metrics.png["tableau de bord-moniteur-affichage-mesures"]
