...
+
image::dremio-add-source-general.png[Nouvelle source - général]
...
+
image::dremio-add-source-advanced.png[Nouvelle source - Options avancées]
...
*Exemple de capture d'écran*
+
image::dremio-source-added.png[Nouvelle source de données ajoutée]
