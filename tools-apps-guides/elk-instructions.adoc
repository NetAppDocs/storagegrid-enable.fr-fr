...
image::logstash-7.17.fields-sample.png[Échantillon Logash 7.17]

*Logstash 8.23 échantillon*

image::logstash-8.x.fields-sample.png[Échantillon Logash 8.23]
...
+
image::kibana-import-options.png[Options d'importation Kibana]
...
+
image::kibana-import-conflict.png[Conflit Kibana]
