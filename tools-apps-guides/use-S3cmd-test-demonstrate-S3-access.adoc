...
Pour installer S3cmd sur un poste de travail ou un serveur, téléchargez-le à partir de https://["Client S3 en ligne de commande"^]. S3cmd est préinstallé sur chaque nœud StorageGRID comme outil pour faciliter le dépannage.
